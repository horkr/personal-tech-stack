...
public class TextParseUtils {
	private static final Logger log = LogManager.getLogger(TextParseUtils.class);
	...
	public static long selectNumFromText(String text) {
		...
		if (!TextParseUtils.matchOne(text, "\\d+([\u4e00-\u9fa5a-zA-Z])", "\\d+.\\d+([\u4e00-\u9fa5a-zA-Z])")) {
