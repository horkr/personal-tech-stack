package com.horkr.spring.learn.cache;
...
public class CacheController {
    @RequestMapping("/etag")
    public ResponseEntity<String> etag(@RequestHeader(value="IF-Modified-Since",required = false) Date ifModifiedSince) {
    ...
    public ResponseEntity<String> cacheControl(@RequestHeader(value="IF-Modified-Since",required = false) Date ifModifiedSince) {
